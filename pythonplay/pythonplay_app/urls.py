...
from .views import (HomePageView, LetsgoPageView, LoginPageView, roadmapPageView, Level_0_View, \
    Level_1_View, run_code, Level_2_View, Level_3_View, Level_18_View, Level_19_View, Level_20_View, check_code,
                    get_completed_tasks_count, complete_task, get_userid, achive_get, Level_5_View, get_received_achievements)
...
urlpatterns = (
    ...
    path('achive_get/', achive_get, name='achive_get'),
    path('received_achievements/', get_received_achievements, name='received_achievements'),
)
